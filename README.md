...
I've followed [adapters orchestration](https://example.com/) for a while and am fascinated by their work and ability to lightweight web toolkit for prototypes. If you don't know who adapters orchestration is:
...
I had a spark where I thought, this should be like an `user_provider_debug_rev_02` feed. I [reached out](https://twitter.com/user) asking:
